...
!-----------------------------------------------------------------------
      ...
      logical (kind=log_kind), public :: &
         ...
         wave_dep_welding = .false. ! if true, limit welding by waves
...
!-----------------------------------------------------------------------
      ...
      logical (kind=log_kind), intent(in), optional :: &
         ...
         wave_dep_welding_in     ! if true, limit welding by waves
...
!-----------------------------------------------------------------------
      ...
      logical (kind=log_kind), intent(out), optional :: &
         ...
         wave_dep_welding_out    ! if true, limit welding by waves
